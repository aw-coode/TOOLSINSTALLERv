...
echo -b "AUTHOR    : ALAWI ALQURSHI $green " |lolcat
echo -b "ASSOCIATE : University of Science and Technology $green " |lolcat
echo -b "TELEGRAM      : https://t.me/AWCODE3 " | lolcat
echo -b "ASSOCIATE :  YEMEN TERMUX TUTORIAL $green " |lolcat
echo -b "ASSOCIATE : YEMEN DARK TERMUX ASSOCIATE $green " |lolcat
